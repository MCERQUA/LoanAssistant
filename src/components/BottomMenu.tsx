    ...
    <div className="fixed bottom-0 left-0 right-0 bg-gray-900/90 backdrop-blur-md border-t border-gray-800 py-2 px-4">
      <div className="max-w-4xl mx-auto flex justify-between items-center gap-2">
        ...
        <a 
          ...
          className="flex-[1.2] bg-gradient-to-b from-blue-600 to-blue-700 px-3 py-3 sm:px-6 sm:py-4 rounded-xl text-white font-semibold shadow-lg hover:from-blue-500 hover:to-blue-600 transition-all transform hover:-translate-y-1 active:translate-y-0 text-sm sm:text-base text-center"
        >
          Start Now
        </a>
